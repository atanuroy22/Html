...
! function($) {
    ...
    var checkActions_intern = function(a, b, c) {
            c && jQuery.each(c, function(c, d) {
                d.delay = parseInt(d.delay, 0) / 1e3, a.addClass("noSwipe"), b.fullscreen_esclistener || "exitfullscreen" != d.action && "togglefullscreen" != d.action || (jQuery(document).keyup(function(b) {
        ...
        actionSwitches = function(tnc, opt, a, _nc) {
            switch (a.action) {
                ...
                case "toggle_mute_video":
                    ...
                    break;
                case "toggle_global_mute_video":
                    _nc.hasClass("rs-toggle-content-active") ? (opt.globalmute = !0, void 0 != opt.playingvideos && opt.playingvideos.length > 0 && jQuery.each(opt.playingvideos, function(a, b) {
                        _R.muteVideo && _R.muteVideo(b, opt)
                    })) : (opt.globalmute = !1, void 0 != opt.playingvideos && opt.playingvideos.length > 0 && jQuery.each(opt.playingvideos, function(a, b) {
